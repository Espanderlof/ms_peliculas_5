...
public class PeliculasControllerTest {
    ...
    public void obtenerTodasPeliculasTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/peliculas"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.peliculasList", Matchers.hasSize(2)))
                .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.peliculasList[0].titulo", Matchers.is("Película 1")))
                .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.peliculasList[1].titulo", Matchers.is("Película 2")));
    }
